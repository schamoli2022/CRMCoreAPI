...
namespace CRMCoreAPI.Service
{
    public interface IInvoiceService
    {
        ...
        /// <returns></returns>
        string GetInvoice(int? Status, string OrderSubject, string DealName, string SalesOwner, string LeadOwner, string ContactName, string dateFrom, string dateTo, string AccountName, string leadName, int? statusID, long companyId, long loggedInUserId, int? sourceId, string subModuleCode, string sortBy, string sortExp, byte? isPaged, int? pageSize, int? pageNumber, string searchCondition);
        ...
        string GetcustomFieldInvoice(long companyId, string moduleName, string subModuleCode, long userId);
        ...
        /// <returns>Returns the fields in json string format</returns>
        //string SaveInvoice(string InvoiceData);
    }
}
